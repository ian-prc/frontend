    ...
    <div className="w-screen min-h-screen bg-[#F5F5F5] p-4 flex flex-col items-center">
      ...
      <div className="mt-10 flex items-center gap-2 w-full ">
        <input
          ...
          className="bg-white border-2 border-gray-300 rounded-xl flex-1 py-3 px-4 font-bold italic outline-none focus:border-[#5F9598]"
        />
        <button
          type="submit"
          className="bg-[#5F9598] text-white font-bold py-3 px-6 rounded-xl transition hover:scale-105 active:scale-95 cursor-pointer"
        >
          Add
        </button>
      </div>
